...
public class Helper {
    ...
    public static final LocalDateTime START_TIME = LocalDateTime.of(2016, 1, 1, 0, 0, 0);
    public static final LocalDateTime STOP_TIME = LocalDateTime.of(2016, 1, 1, 1, 0, 0);
