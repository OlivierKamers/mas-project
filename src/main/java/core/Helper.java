...
public class Helper {
    ...
    public static final LocalDateTime START_TIME = LocalDateTime.of(2016, 1, 14, 12, 0, 0);
    public static final LocalDateTime STOP_TIME = LocalDateTime.of(2016, 1, 14, 12, 15, 0);
    public static final Period FIELD_TIME_OFFSET = Period.ofYears(1);
